...
filename = '/MATLAB Drive/LDO_LoopGaindB20_MaxLoadCurrent.csv';
...
hold on
plot(2.511886431509580,75.64528539127550,'.','MarkerSize',20)
hold off

hold on
str = {'\uparrow', 'DC Gain: 75.64'};
text(1.9,50,str,'Color','red')
hold off
...
hold on
str = {'\leftarrow -3dB Bandwidth: 597.781 Hz'};
text(freq_3db + 100,Gain_3db,str,'Color','red')
hold off

hold on
hp3 = plot(158489.3192461120, 28.72, '.','MarkerSize',20);
hold off

hold on
str = {'\leftarrow Gain Margin: 28.72 dB'};
text(158489 + 100000, 28.72, str, 'Color','red')
hold off

xlabel('freq (Hz)')
ylabel('Loop Gain Magnitude (dB)')
title('Loop Gain Magnitude - 10 mA Load Current')
hold on
