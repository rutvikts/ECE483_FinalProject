...
filename = '/MATLAB Drive/LDO_LoopGainPhase_MaxLoadCurrent.csv';
...
hold on
hp3 = plot(3981071.705534980, 82.35, '.','MarkerSize',20);
hold off

hold on
str = {'\leftarrow Phase Margin: 82.35 deg'};
text(3981071 + 100000, 82.35, str, 'Color','red')
hold off

xlabel('Frequency (Hz)')
ylabel('Phase (degrees)')
title('Phase - 10 mA Load Current')
hold on
